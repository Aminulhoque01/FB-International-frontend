...
const ServicesPage: FC = () => {
    ...
    const totalExpense = filteredServices.reduce((sum: number, service: { amount: number }) => sum + service.amount, 0);
                ...
                <table className="min-w-full bg-white border rounded-lg">
                    ...
                    <tbody>
                        {filteredServices.length === 0 ? (
                            ...
                            filteredServices.map((service: { _id: string; title: string; amount: number; date: string; category: string; description: string }) => (
